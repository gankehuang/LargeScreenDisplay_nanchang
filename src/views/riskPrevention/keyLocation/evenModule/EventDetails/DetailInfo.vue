<template>
  <div class="detail-info-container">
    ...
    <el-row class="event-image-info">
      ...
      <el-col :span="20">
        <div
          v-if="baseInfo.snapImageUrl && baseInfo.snapImageUrl !== '-'"
        ...
        <div
          v-if="baseInfo.processingImageUrl && baseInfo.processingImageUrl !== '-'"
  ...
  data () {
    return {
      ...
      baseInfo: {
        ...
        detail: '九龙湖赣江南大道和龙兴大街交汇红绿灯处，下水道淤积，存在安全隐患，望及时处理。'
      },

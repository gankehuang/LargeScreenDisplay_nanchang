        ...
        <el-row :gutter="20">
          ...
          <el-col :span="24">
            <el-form-item label="关注日期:">
              <el-select v-model="form.date" placeholder="请选择持续时间">
                <el-option
          ...
          <el-col :span="24">
            <el-form-item label="持续时间:">
              <el-select v-model="form.duration" placeholder="请选择持续时间">
                <el-option
          ...
          <el-col :span="24">
            <el-form-item label="第一圈层:">
              <el-input v-model="form.tier1" style="width: 80px"></el-input
              ><label>米</label>
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="第二圈层:">
              <el-input v-model="form.tier2" style="width: 80px"></el-input
              ><label>米</label>
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="第三圈层:">
              <el-input v-model="form.tier3" style="width: 80px"></el-input
              ><label>米</label>
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="监控区域:">
              <el-select v-model="form.monitor" placeholder="请选择监控区域">
                <el-option

  ...
  >
    ...
    <div class="content">
      <div class="content-left">
        ...
        <div class="center">
          姓名：{{ gridAdmin.name | hideName }}
        </div>
        <div class="center">
          电话：{{ gridAdmin.phone | hidePhone }}
        </div>
...
export default {
  ...
  methods: {
    openBefore () {
      this.loading = true
      this.curPostionText = this.info.path

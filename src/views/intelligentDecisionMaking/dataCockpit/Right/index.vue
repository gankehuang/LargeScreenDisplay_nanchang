<template>
  <div class="dataCockpit-right">
    <InfoBlock
      title="风险预警"
      height="35%"
      :title-bg-url="infoBlockTitleBg"
...
const infoBlockTitleBg = require('@/assets/image/dataCockpit/block-title.png')
export default {
  components: {
    ColumnsAnimationModal
  },
  ...
  data () {
    return {
      infoBlockTitleBg: infoBlockTitleBg,
      columnsAnimationModal: {
        visible: false,
        info: null
      },

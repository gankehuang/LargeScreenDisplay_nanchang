<template>
  ...
  >
    ...
    >
      ...
      <el-table-column label="事件类型" prop="typeText" />
      <el-table-column label="事件来源" prop="sourceText" />
      <el-table-column label="发生时间" prop="happenedTime" width="180" />
      <el-table-column label="事件地点" prop="location" />
      <el-table-column label="事件等级" prop="emergencyLevelText" />
      <el-table-column label="事件图片" prop="snapImageUrl">
